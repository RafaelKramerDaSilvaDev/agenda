...
const PassValuesToEditContext = createContext<PassValuesToEditContextType>({} as PassValuesToEditContextType);

type PassValuesToEditProviderProps = {
	children: ReactNode;
};

export function PassValuesToEditProvider({ children }: PassValuesToEditProviderProps) {
...
export function usePassValuesToEdit() {
	...
	if (context === undefined) {
		throw new Error('usePassValuesToEdit deve ser usado dentro de um PassValuesToEditProvider');
	}
	return context;
}
